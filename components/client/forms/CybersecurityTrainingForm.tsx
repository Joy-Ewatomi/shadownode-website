  ...
  const updateForm = useCallback(
    (
      ...
      setForm((prev) => {
        ...
        /*
         * Automatically keep currency
         * synchronized with country.
         */
        if (
          ...
          next.preferred_currency =
            getCurrency(patch.client_country)
        }
    ...
    switch (step) {
      ...
      case 2:
        return (
          ...
          Boolean(form.training_duration) &&
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between border-t border-[#143b28] pt-6">
        <button
          ...
          className="rounded-md border border-[#143b28] px-5 py-2 text-sm text-white/70 transition hover:bg-white/5 disabled:cursor-not-allowed disabled:opacity-40"
        >
          Previous
        </button>
        ...
        {step < STEPS.length ? (
          <button
            ...
            className="rounded-md bg-[#20dc73] px-6 py-2 text-sm font-semibold text-black transition hover:bg-[#20dc73]/90 disabled:cursor-not-allowed disabled:opacity-40"
          >
            Next
          </button>
        ) : (
          <button
            ...
            className="flex items-center gap-2 rounded-md bg-[#20dc73] px-6 py-2 text-sm font-semibold text-black transition hover:bg-[#20dc73]/90 disabled:cursor-not-allowed disabled:opacity-40"
          >
            {submitting && (
              <Loader2
