...
const STEPS = [
  { id: 1, label: "Training Service" },
  { id: 2, label: "Training Details" },
  { id: 3, label: "Communication Preferences" },
  { id: 4, label: "Review & Authorization" },
]
...
export default function CybersecurityTrainingForm({ onSubmit, submitting }: Props) {
